            ...
            <div class="col-sm-12">
              <div class="home-tab">
                ...
                if ($_SESSION['data-user']['role'] == 4) {
                  $januari = mysqli_query($conn, "SELECT * FROM penjualan_detail JOIN penjualan ON penjualan_detail.id_penjualan=penjualan.id_penjualan JOIN pembayaran ON penjualan.id_penjualan=pembayaran.id_penjualan JOIN produk ON penjualan_detail.id_produk=produk.id_produk JOIN distributor ON produk.id_distributor=distributor.id_distributor WHERE distributor.id_user='$idUser' AND month(penjualan_detail.updated_at)='01'");
                  $januari = mysqli_num_rows($januari);
